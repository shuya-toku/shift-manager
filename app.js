...
function seedInitialData() {
  ...
  state.employees = [
    // Japanese full-time
    { id: '009', name: 'Ms.Mizuki', nationality: 'JP', employment: 'FT', roles: ['JP'],         targetDays: 22, defaultStart: '08:00', defaultEnd: '16:00', defaultBreakMin: 60, workableDow: [1,2,3,4,5], notes: '5.5day/week' },
    ...
    { id: '102', name: 'Mr. Kanai', nationality: 'JP', employment: 'FT', roles: ['JP'],         targetDays: 22, defaultStart: '13:00', defaultEnd: '22:00', defaultBreakMin: 60, workableDow: [0,1,2,3,4,5,6], notes: '' },
    ...
    { id: '021', name: 'Meng Zeang', nationality: 'KH', employment: 'FT', roles: ['Op(JP/EN)'],    targetDays: 22, defaultStart: '07:00', defaultEnd: '16:00', defaultBreakMin: 60, workableDow: [0,1,2,3,4,5,6], notes: '' },
    { id: '068', name: 'Chanleak', nationality: 'KH', employment: 'FT', roles: ['Op(JP/EN)'],      targetDays: 22, defaultStart: '07:00', defaultEnd: '16:00', defaultBreakMin: 60, workableDow: [0,1,2,3,4,5,6], notes: '' },
    ...
    { id: '036', name: 'Kongkea Chan', nationality: 'KH', employment: 'PT', roles: ['Op(JP/EN)'],  targetDays: 8,  defaultStart: '15:00', defaultEnd: '19:00', defaultBreakMin: 0, workableDow: [1,2,3,4],     notes: 'PT' },
    ...
    { id: '099', name: 'Mr. Meng Mao', nationality: 'KH', employment: 'FT', roles: ['Op(JP/EN)'],  targetDays: 22, defaultStart: '12:00', defaultEnd: '21:00', defaultBreakMin: 60, workableDow: [0,1,2,3,4,5,6], notes: '12-21' },
    { id: '083', name: 'Ms. Sok Chansreyroth', nationality: 'KH', employment: 'FT', roles: ['Op(JP/EN)'], targetDays: 22, defaultStart: '12:00', defaultEnd: '21:00', defaultBreakMin: 60, workableDow: [0,1,2,3,4,5,6], notes: '12-21' },
    { id: '081', name: 'Mr. Lun Socheath', nationality: 'KH', employment: 'PT', roles: ['Op(JP/EN)','Night'], targetDays: 10, defaultStart: '18:00', defaultEnd: '22:00', defaultBreakMin: 0, workableDow: [0,1,2,3,4,5,6], notes: '18:30-22:30, 目安週6' },
    { id: '103', name: 'Ms. Kakada', nationality: 'KH', employment: 'FT', roles: ['Op(JP/EN)'],    targetDays: 22, defaultStart: '08:00', defaultEnd: '17:00', defaultBreakMin: 60, workableDow: [0,1,2,3,4,5,6], notes: '8-17' },
  ];
